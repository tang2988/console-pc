	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input  name="title" type="text" id="title"  value="${map.title}" /></td>
			</tr>

			<tr>
				<td align="right" class="l-table-edit-td">内容:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="content" type="text" id="content" value="${map.content}" /></td>
			</tr>

			<tr>
				<td align="right" class="l-table-edit-td">图片地址:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="imageruri" type="text" id="imageruri"  value="${map.imageruri}" /></td>
			</tr>
		...
		<input type="hidden" value="${map.announcementId}" name="announcementId" />
...
<script type="text/javascript">
        // 保存数据
        function ssaveFrom(){
        	$.post("${ctx}/Announcement/update1.do", $("#form1").serialize(), function (msg) { 
                if(msg=="true"){
