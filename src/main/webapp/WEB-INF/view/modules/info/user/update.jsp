				...
				<td colspan="4">
					<div class="l-group l-group-hasicon">
						<img
							...
							style="margin-left:0px;">修改信息</span>
					</div>
				</td>
			</tr>
			
			<tr>
				<td align="right" class="l-table-edit-td">用户ID:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="UserId" type="text" id="UserId" value="${map.userId}" />
...
<script type="text/javascript">
        ...
        // 保存数据
        function ssaveFrom(){
        	$.post("${ctx}/User/Modifytheuser.do", $("#form1").serialize(), function (msg) { 
                if(msg=="true"){
