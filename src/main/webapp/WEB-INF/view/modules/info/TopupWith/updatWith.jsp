...
<body style="padding:10px">
	...
	<form name="form1" method="post" action="" id="form1">
				...
				<td colspan="4">
					<div class="l-group l-group-hasicon">
						<img
							...
							style="margin-left:0px;">提现审核</span>
					</div>
				</td>
			</tr>
			
			<tr>
				<td align="right" class="l-table-edit-td">银行卡id:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="withdrawalId" type="text" id="withdrawalId" value="${araay.withdrawalId}" />
		...
		<input type="hidden" value="${araay.withdrawalId}" name="withdrawalId" /> 
...
<script type="text/javascript">
        ...
        // 保存数据
        function ssaveFrom(){
        	$.post("${ctx}/Topupwith/modifystate.do", $("#form1").serialize(), function (msg) { 
                if(msg=="true"){
