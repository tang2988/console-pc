	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="productType" type="text" id="productType" />
			...
			<tr>
				<td align="right" class="l-table-edit-td">克重:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="gramWeight" type="text" id="gramWeight"  />
				...
				<td align="right" class="l-table-edit-td">品牌:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="brand" type="text" id="brand"  />
				...
				<td align="right" class="l-table-edit-td">产品价格:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="productPrice" type="text" id="productPrice"  />
				...
				<td align="right" class="l-table-edit-td">库存:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="bepertory" type="text" id="bepertory"  />
				...
				<td align="right" class="l-table-edit-td">详情页:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="detailpage" type="text" id="detailpage"  />
				...
				<td align="right" class="l-table-edit-td">产品名称:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="productName" type="text" id="productName"  />
				...
				<td align="right" class="l-table-edit-td">状态:&nbsp;&nbsp;<span
					style="color:red;">*</span></td>
				<td align="left" class="l-table-edit-td"><input name="productStatus" type="text" id="productStatus"  />
...
<script type="text/javascript">
        ...
        // 保存数据
        function ssaveFrom(){
        	$.post("${ctx}/produ/add.do", $("#form1").serialize(), function (msg) { 
                if(msg=="true"){
