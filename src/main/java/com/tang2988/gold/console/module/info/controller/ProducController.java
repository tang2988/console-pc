...
//		 
	...
	@RequestMapping("findAllPageIntoXLS")
	@ResponseBody
	public void findAllPageIntoXLS(
			HttpServletResponse resp) {

		Workbook workbook = productinformationService.findAllPageIntoXLS( );
		try {
			resp.addHeader("Content-Disposition", "attachment; filename=tys.xls");
...
//			model.addAttribute("json", JSONObject.parse(json.get("prod uct")+""));
//		} catch (ClientProtocolException e) {
//			e.printStackTrace();
//		} catch (IOException e) {
//			e.printStackTrace();
